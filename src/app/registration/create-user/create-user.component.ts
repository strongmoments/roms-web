...
export class CreateUserComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.form = this.fb.group({
      empNo: new FormControl(this.userSessionData?.employeeNo, [
        Validators.required,
        Validators.pattern(this.utils.intRegex),
        Validators.maxLength(15),
      ]),
      firstName: new FormControl(this.userSessionData?.firstName, [
        Validators.required,
        Validators.maxLength(25),
      ]),
      lastName: new FormControl(this.userSessionData?.lastName, [
        Validators.required,
        Validators.maxLength(25),
      ]),
      email: new FormControl(this.userSessionData?.email, [
        Validators.required,
        Validators.pattern(this.utils.emailRegex),
        Validators.maxLength(30),
      ]),
      contactNo: new FormControl(this.userSessionData?.phone, [
        Validators.required,
